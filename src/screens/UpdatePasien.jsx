...
export class UpdatePasien extends React.Component {
	/** 
	 * Akses method getDetailPasien(idPasien) pada Appointment dan lakukan update state. 
	...
	handleFormSubmit(e) {
		e.preventDefault()
		/** 
		 * Akses method updateStatusPasien(requestBody) pada Appointment dan lakukan update state. 
		 */
		this.setState({
			loading: true
		})
